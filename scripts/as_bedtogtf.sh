...
TRACKING_FILE="/groups/berger/user/elin.axelsson/projects/projects_2025/pacbio/paper25/output/gffcompare/only_antisense.tracking"  # File containing identifiers to filter BED rows (x=antisense
BASENAME=$(basename $BED_FILE .bed)

# Output directories and files
OUTPUT_DIR="/groups/berger/user/elin.axelsson/projects/projects_2025/pacbio/paper25/output/only_as"  # Folder to store .gtf files
